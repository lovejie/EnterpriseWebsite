                        ...
                        <div class="tab-pane active" id="portlet_comments_1">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <form class="form-horizontal" role="form" action="{{url("admin/serverstype/update")}}" method="post">
                                        {!! csrf_field() !!}
                                       ...
                                       {{-- <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="name_add" value="{{$datas->name}}" name="name" placeholder="型号名称" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="title_add" class="col-sm-1 control-label">CPU</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="cpu_add" value="{{$datas->cpu}}" name="cpu" placeholder="请输入CPU信息" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="title_add" class="col-sm-1 control-label">内存</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="memory_add" value="{{$datas->memory}}" name="memory" placeholder="请输入内存信息" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="title_add" class="col-sm-1 control-label">硬盘</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="harddisk_add" value="{{$datas->harddisk}}" name="harddisk" placeholder="请输入硬盘信息" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="title_add" class="col-sm-1 control-label">带宽/流量</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="bandwidth_add" value="{{$datas->bandwidth}}" name="bandwidth" placeholder="带宽/流量" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="title_add" class="col-sm-1 control-label">IP支持</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="ipnum_add" value="{{$datas->ipnum}}" name="ipnum" placeholder="IP支持" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="title_add" class="col-sm-1 control-label">服务标准</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="stand_add" value="{{$datas->stand}}" name="stand" placeholder="服务标准" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="title_add" class="col-sm-1 control-label">价格</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="price_add" value="{{$datas->price}}" name="price" placeholder="价格" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="title_add" class="col-sm-1 control-label">规格</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="size_add" value="{{$datas->size}}" name="size" placeholder="规格" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
@section('script')
    ...
    <script>
        fillSelectServer("server","mode_add",{{$datas->mode}});
        var ue = UE.getEditor('desc_add', {

                        ...
                        <div class="tab-pane active" id="portlet_comments_1">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <form class="form-horizontal" role="form" action="{{url("admin/news/store")}}" method="post">
                                        {!! csrf_field() !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <textarea name="contents" id="contents_add"  required></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
@section('script')
    ...
    <script>
        fillSelectServer("news","mode_add");

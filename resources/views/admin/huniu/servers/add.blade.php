                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase"> 新增公告</span>
                                    </div>
                                </div>
                                <div class="portlet-body">

                                    <form class="form-horizontal" role="form" action="{{url("admin/servers/store")}}" method="post">
                                        {!! csrf_field() !!}
                                        {{--<div class="form-group">
                                            <label for="title_add" class="col-sm-1 control-label">标题</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="title_add"  name="title" placeholder="请输入标题" required>
                                            </div>
                                        </div>--}}
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="contents_add" class="col-sm-1 control-label">简介</label>
                                            <div class="col-sm-7">
                                                <textarea name="desc" id="desc_add"  required></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">

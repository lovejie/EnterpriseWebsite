...
<!--中间调用部分开始-->
<h2 class="detail_title">成都移动机房介绍</h2>
<div class="content"> 
	<p>
    	中国移动四大核心节点之一,全面负责中国互联网数据的存储、交换和传输的国家电信级数据中心。成都移动数据中心机房面积超过5000平米,拥有直连国家骨干核心、省网核心、城域网核心的网络宽带资源及专业电信级网络工程维护人员近百名。</p>
<div class="tg_list01">
 <table width="980" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
  ...
  <tr>
    ...
    <td height="50" align="center" bgcolor="#FFFFFF"><span>25000元</span>/年</td>
    <td height="50" align="center" bgcolor="#FFFFFF"><span>28000元</span>/年</td>
    <td height="50" align="center" bgcolor="#FFFFFF"><span>31000元</span>/年</td>
    <td height="50" align="center" bgcolor="#FFFFFF"><span>80000元</span>/年</td>
  </tr>
  <tr>
    ...
    <td height="50" align="center" bgcolor="#FFFFFF">1A</td>
    <td height="50" align="center" bgcolor="#FFFFFF">1A</td>
    <td height="50" align="center" bgcolor="#FFFFFF"><span>16A</span>电流</td>
  </tr>
  <tr>
    ...
    <ul class="introduce">
    	<li>A级机房非常稳定</li>
        <li>中国移动四大骨干数据交换中心之一</li>
        <li>电力保障：双路电源引入，供电率达99.999% </li>
        <li>数据中心测试IP：183.221.242.1 </li>

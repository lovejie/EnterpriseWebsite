...
<!--中间调用部分开始-->
<h2 class="detail_title">美国洛杉矶机房介绍</h2>
<div class="content"> 
	<p>
    	美国洛杉矶UBI接入180Gbps带宽至HE,GTT,NTT,CO等线路，有效保障网络的稳定性和高速性Juniper MX240 高端交换机路由器支撑IDC内部骨干IDC内部骨干网络设备采用双机备份双上联路由。</p>
<div class="tg_list01">
 <table width="980" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
  ...
  <tr>
    ...
    <ul class="introduce">
    	<li>A级机房非常稳定</li>
        <li>洛杉矶电信大楼机房，超过100家运营商接入</li>
        <li>电力保障：双路电源引入，供电率达99.999% </li>
        <li>数据中心测试IP：23.19.47.49 </li>
